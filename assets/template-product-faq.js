...
/***/ "./src/styles/sections/template-product-faq.scss":
/*!*******************************************************!*\
  !*** ./src/styles/sections/template-product-faq.scss ***!
  \*******************************************************/
/***/ (function(__unused_webpack_module, __webpack_exports__, __webpack_require__) {

eval("__webpack_require__.r(__webpack_exports__);\n// extracted by mini-css-extract-plugin\n\n\n//# sourceURL=webpack://allaboutinterior/./src/styles/sections/template-product-faq.scss?");

/***/ }),

/***/ "./src/scripts/sections/template-product-faq.js":
/*!******************************************************!*\
  !*** ./src/scripts/sections/template-product-faq.js ***!
  \******************************************************/
/***/ (function(__unused_webpack___webpack_module__, __webpack_exports__, __webpack_require__) {

eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var _snippets_drop_menu_dr_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../snippets/drop-menu-dr.js */ \"./src/scripts/snippets/drop-menu-dr.js\");\n/* harmony import */ var _styles_sections_template_product_faq_scss__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../../styles/sections/template-product-faq.scss */ \"./src/styles/sections/template-product-faq.scss\");\n\n\nwindow.addEventListener(\"DOMContentLoaded\", () => (0,_snippets_drop_menu_dr_js__WEBPACK_IMPORTED_MODULE_0__[\"default\"])());\n\n//# sourceURL=webpack://allaboutinterior/./src/scripts/sections/template-product-faq.js?");

/***/ }),

/***/ "./src/scripts/snippets/drop-menu-dr.js":
/*!**********************************************!*\
  !*** ./src/scripts/snippets/drop-menu-dr.js ***!
  \**********************************************/
/***/ (function(__unused_webpack___webpack_module__, __webpack_exports__, __webpack_require__) {

eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var _utils_index_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../utils/index.js */ \"./src/scripts/utils/index.js\");\n\n/* harmony default export */ __webpack_exports__[\"default\"] = (() => {\n  const dropdownElements = document.querySelectorAll(\"[data-dropdown]\");\n  if (!dropdownElements.length) return;\n  dropdownElements.forEach(dropdownElement => {\n    const headElement = dropdownElement.querySelector(\"[data-dropdown-header]\");\n    const contentElement = dropdownElement.querySelector(\"[data-dropdown-content]\");\n    contentElement.style.maxHeight = \"0\";\n    const closeBrothers = () => {\n      dropdownElements.forEach(checkDropdownElement => {\n        const checkDropdownMarker = checkDropdownElement.getAttribute(\"data-dropdown\");\n        const dropdownMarker = dropdownElement.getAttribute(\"data-dropdown\");\n        if (checkDropdownMarker === dropdownMarker) {\n          const checkDropdownItemContent = checkDropdownElement.querySelector(\"[data-dropdown-content]\");\n          (0,_utils_index_js__WEBPACK_IMPORTED_MODULE_0__.changeElementClassByStatus)(checkDropdownElement, false, \"open\");\n          checkDropdownItemContent.style.maxHeight = \"0\";\n        }\n      });\n    };\n    const onClick = () => {\n      if (dropdownElement.hasAttribute(\"data-dropdown-close-others\")) closeBrothers();\n      (0,_utils_index_js__WEBPACK_IMPORTED_MODULE_0__.changeElementClassByStatus)(dropdownElement, true, \"open\");\n      contentElement.style.maxHeight = +contentElement.scrollHeight + +contentElement.style.paddingTop + \"px\";\n    };\n    if (dropdownElement.hasAttribute(\"data-dropdown-first\")) onClick();\n    if (dropdownElement.hasAttribute(\"data-dropdown-trigger-by-body\")) dropdownElement.addEventListener(\"click\", () => onClick());else headElement.addEventListener(\"click\", () => onClick());\n  });\n});\n\n//# sourceURL=webpack://allaboutinterior/./src/scripts/snippets/drop-menu-dr.js?");
...
/******/ 	var __webpack_exports__ = __webpack_require__("./src/scripts/sections/template-product-faq.js");
/******/ 	
/******/ })()
;